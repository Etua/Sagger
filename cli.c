  ...
  if (argc == 2) {
    if (strcmp(argv[1], "-h") == 0 || strcmp(argv[1], "--help") == 0) {
      printf("Usage: sagger [OPTIONS] SOURCE_DIRECTORY TARGET_DIRECTORY\n\n"
             "Tag audio files using AcoustID fingerprints and MusicBrainz "
             "database.\n\n"
             "Options:\n  -album/-artist/-both choose what to include in "
             "directory name and filename. "
             "Two arguments are mandatory, song name is included in filename "
             "each time.\n"
             "  -h/--help print this help\n"
             "  -v/--version print version number and license\n\n"
             "If no options are specified, the program is set to run in GUI "
             "mode.\n\n"
      ...
      printf("%s %s\nCopyright (C) 2020 Dominik Danelski\n\n"
             ...
             "More information in the COPYING file and license notices in the "
             "source files.\n\n"
             "Website: https://github.com/Etua/Sagger\n",
